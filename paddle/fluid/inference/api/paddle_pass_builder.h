...
// TODO(Superjomn) Consider the way to mix CPU with GPU.
  ...
  // Only INT8 quantization is supported now
  void EnableQuant() override {
    if (!use_int8_) {
      passes_.push_back("int8_placement_pass");
      passes_.push_back("quant_gather_var_names_pass");
    }
    use_int8_ = true;
  }
