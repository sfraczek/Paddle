...
void patterns::FcParallel::operator()() {
  auto *fc1 = pattern->NewNode(fc1_repr())->AsIntermediate()->assert_is_op("fc");
  auto *fc2 = pattern->NewNode(fc2_repr())->AsIntermediate()->assert_is_op("fc");
  auto *fc3 = pattern->NewNode(fc3_repr())->AsIntermediate()->assert_is_op("fc");
